// apps/api/src/migrations/1709500000000-InitialSchema.ts
import { MigrationInterface, QueryRunner } from 'typeorm';

/**
 * Initial migration: creates all tables, indexes, views, and triggers.
 * This is the canonical source of truth for the DB schema.
